...
http://wptest.comedical.jp/archives/4?code=3
...
function post()
{
  ...
  ### hykwWPData_post
  assert_equal('p1', '4', hykwWPData_post::iget_id());
  assert_equal('p2', 'http://wptest.comedical.jp/archives/4', hykwWPData_post::iget_permalink(FALSE));
  assert_equal('p3', 'http://wptest.comedical.jp/archives/4', hykwWPData_post::get_permalink(4, FALSE));

  assert_equal('p4', '/archives/4', hykwWPData_post::iget_permalink());
  assert_equal('p5', '/archives/4', hykwWPData_post::iget_permalink(TRUE));
  assert_equal('p6', '/archives/4', hykwWPData_post::get_permalink(4, TRUE));
  assert_equal('p7', '/archives/4', hykwWPData_post::get_permalink(4));



  assert_equal('p3-2', '', hykwWPData_post::get_permalink(99999));
